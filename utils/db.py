...
class Database:
    ...
    async def _seed_config_live(self, engine_config: dict = None, micro_config: dict = None):
        ...
        SCHEMA = [
            ...
            ("micro",  "MAX_STAKE_Q80_1D", 50.0,  "float", "Cap $ for Q≥80 + ≤1d trades — middle tier between Q80_6H ($75) and standard MAX_STAKE_1D ($35)", 5.0,  300.0,"sizing"),
            ("micro",  "PCT_STAKE_Q80",    0.075, "float", "Kelly fraction for Q≥80 tiers (vs 0.05 default) — bumped because WR is near 100%", 0.02, 0.20, "sizing"),
            # Micro — capacity
