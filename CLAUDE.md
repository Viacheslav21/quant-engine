...
- **Kelly criterion**: 0.15 fraction (conservative), spread penalty (3-10¢ → 1.0-0.3x multiplier), capped at MAX_KELLY_FRAC of bankroll. Contrarian trades: Kelly × 0.5. Per-theme Bayesian Kelly multiplier (0.3–2.0×) from trade history. Theme concentration penalty reduces Kelly when >20% bankroll in one theme.
